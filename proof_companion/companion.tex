...
a no-go result separating discrete meshes from continuum kernels, and a concrete
nonconstant family. The selection is explicit in \nolinkurl{selection.json}.
...
chose to discuss. One further module contributes a single witness. Coverage of
the rest of the development remains selected, and the coverage table records
exactly which declarations are present.
