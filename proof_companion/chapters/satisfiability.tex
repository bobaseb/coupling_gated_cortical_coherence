...
\subsection{All eight arrows in one composition}
\begin{claim}
...
\scope The components are separate toy constructions with different state spaces.
The field, cover and reflexive boundary share the three-site substrate.
...
The development discharges its hypotheses with four arrangements: with a noisy
actuator, with that actuator held to a named
...
\scope The register-budget arrangement changes $E34Active$: its heat allocation
is derived from the register's ledger. The actuated and microscopic arrangements
change $E45Active$, the arrow feeding coarse-graining, using process-dependent
spatial energies. All four retain the same downstream field, cover and boundary.
They demonstrate several ways to satisfy the hypotheses; they do not identify
one common physical mechanism.
