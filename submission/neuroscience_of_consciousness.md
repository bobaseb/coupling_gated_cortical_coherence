...
|---|---|---|
| Research Article length | ≤ 9,000 words | 8,729 words of main text by `detex -n` (TikZ excluded, references not followed); 249 abstract, 399 notation table, 275 back matter. Main text plus abstract is 8,978; with notation and back matter 9,652, so confirm with the editorial office whether the notation table counts |
