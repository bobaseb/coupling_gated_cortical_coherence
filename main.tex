...
Accuracy concerns the variables represented by $s_*$, rather than every microscopic physical fact. A cortical realization must specify those variables and justify the required fidelity. Approximate self-models, errors and changing states may require a weaker condition than the exact fixed point established here.
