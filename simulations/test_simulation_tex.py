...
class SimulationTexTest(unittest.TestCase):
    def test_generator_reads_saved_outputs_without_running_integrators(self) -> None:
        ...
        self.assertIn(r"\newcommand{\wavePatchChordBound}{382.5}", content)
        self.assertIn(r"\newcommand{\wavePatchInformativeSites}{3}", content)
        self.assertIn(r"\newcommand{\wavePatchPairFraction}{0.37}", content)
        self.assertIn(r"\newcommand{\waveNeighbourChordBound}{0.1388}", content)
        self.assertIn(r"\newcommand{\waveNerveDiameters}{14}", content)
        self.assertIn(r"\newcommand{\waveNerveHops}{13}", content)
        self.assertIn(r"\newcommand{\waveNerveReachMm}{0.219}", content)
